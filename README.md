...
Scripts are inline and optional: a theme toggle, a live search on the market page,
and a "now playing" panel on the line-up. Without JavaScript every page still works.
...
| `programme.html` | The 13 map areas, market areas, 41 highlights and the Academy workshops |
...
Total: 20 pages + 2 calendar files, ~600 KB including the map image (`vendors.html` is the largest page at 38 KB — 110 stalls with descriptions). First paint of the home page is
