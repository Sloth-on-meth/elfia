...
Total: 18 pages + 2 calendar files, ~600 KB including the map image (`vendors.html` is the largest page at 38 KB — 110 stalls with descriptions). First paint of the home page is
